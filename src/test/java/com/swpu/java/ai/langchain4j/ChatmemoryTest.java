...
import com.swpu.java.ai.langchain4j.assistant.MemoryAssistant;
...
public class ChatmemoryTest {
    ...
    public void testChatMemory() {
        String answer1 = assistant.chat("我是谭浩然");
    ...
    public void testChatMemory2() {
        //第一轮对话
        UserMessage userMessage1 = UserMessage.userMessage("我是谭浩然");
    ...
    /**
     * 有聊天记忆，自动管理历史对话,通过@AiService注解配置
     */
    @Autowired
    private MemoryAssistant memoryAssistant;
    @Test
    public void testChatMemory4() {
        String answer1 = memoryAssistant.chat("我是谭浩然");
        System.out.println(answer1);
    ...
    /**
     * 有聊天记忆，自动管理历史对话,通过@AiService注解配置,并且支持多用户
     */
    @Autowired
    private SeparateChatAssistant separateChatAssistant;
    @Test
    public void testChatMemory5() {
        String answer1 = separateChatAssistant.chat(1,"我是谭浩然");
        System.out.println(answer1);
